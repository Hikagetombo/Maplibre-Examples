...
// インポート属性を使ってJSONファイルをインポート
//import data from './shelter_point.json' with { type: 'json' };

const res = await fetch("./src/shelter_point.json");
const shelterPointData = await res.json();
